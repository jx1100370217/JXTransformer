...
class ConfigSpecification:
    ...
    def _define_param_specs(self):
        ...
        group.append(ParameterSpecification(
            name='saveto', default='model/transformer',
            visible_arg_names=['--model'], hidden_arg_names=['--saveto'],
            type=str, metavar='PATH',
            help='model file name (default: %(default)s)'))

        group.append(ParameterSpecification(
            name='reload', default='latest_checkpoint',
        ...
        group.append(ParameterSpecification(
            name='summary_dir', default='summary',
        ...
        group.append(ParameterSpecification(
            name='summary_freq', default=10000,
        ...
        group.append(ParameterSpecification(
            name='model_type', default='transformer',
        ...
        group.append(ParameterSpecification(
            name='output_hidden_activation', default='prelu',
        ...
        group.append(ParameterSpecification(
            name='learning_schedule', default='transformer',
        ...
        group.append(ParameterSpecification(
            name='finish_after', default=100000000,
        ...
        group.append(ParameterSpecification(
            name='valid_batch_size', default=160,
